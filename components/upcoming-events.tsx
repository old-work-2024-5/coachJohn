...
// Extend the Event type with additional optional properties.
interface ExtendedEvent extends Event {
  image?: string
  flyerSrc?: string
  registrationUrl?: string
  // Other properties like date, time, location, description, title, and id should already be defined in Event.
}
            ...
            <div className="p-4">
              ...
              <div className="flex gap-2">
                {event.flyerSrc && (
                  <button
                    onClick={() =>
                      setActiveFlyer({ src: event.flyerSrc!, title: event.title })
                    }

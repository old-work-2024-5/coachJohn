...
export const events: Event[] = [
  ...
  },
  {
    ...
    description:
      "A one-day intensive workshop focusing on community leadership skills, problem-solving, and project planning.",
    date: "2024-08-05",
  ...
  },
  {
    ...
    description:
      "Join us for a day of celebration, connection, and fun as we come together to honor the diversity and strength of our community.",
    date: "2024-09-10",
  ...
  },
  {
    ...
    description:
      "Weekly sessions designed to enrich the lives of seniors through activities that promote physical health, mental well-being, and social connection.",
